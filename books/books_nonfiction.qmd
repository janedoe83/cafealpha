...
<div class="books">## Naomi Klein - Doppelganger{.book .personal_favorite .memoir .politics data-country="nan" data-rating="10" data-year="2023" data-title="Doppelganger" data-author="Naomi Klein"}
<div class="album-container"><div class="album-image">![](../img/book_doppelganger.jpeg)</div><div class="album-info"><p class="mb-0"><strong>Subtitle</strong>: A Trip into the Mirror World<br><strong>Year:</strong> 2023<br><strong>Rating:</strong> 10/10<br></p></div></div><div class="toggle-tags"><div class="d-flex flex-wrap gap-2 mb-2 mt-2"><button id="personal_favorite" class="badge bg-primary rounded-pill border-0" onclick="toggleTag(this, 'personal_favorite')">❤️ Personal Favorite</button><button id="memoir" class="badge bg-primary rounded-pill border-0" onclick="toggleTag(this, 'memoir')">Memoir</button><button id="politics" class="badge bg-primary rounded-pill border-0" onclick="toggleTag(this, 'politics')">Politics</button></div></div>
...
<div class="album-container"><div class="album-image">![](../img/book_regenesis.jpeg)</div><div class="album-info"><p class="mb-0"><strong>Subtitle</strong>: Feeding the World Without Devouring the Planet<br><strong>Year:</strong> 2022<br><strong>Rating:</strong> 10/10<br></p></div></div><div class="toggle-tags"><div class="d-flex flex-wrap gap-2 mb-2 mt-2"><button id="essential_reading" class="badge bg-primary rounded-pill border-0" onclick="toggleTag(this, 'essential_reading')">⭐ Essential Reading</button><button id="environment" class="badge bg-primary rounded-pill border-0" onclick="toggleTag(this, 'environment')">Environment</button></div></div>
...
<div class="album-container"><div class="album-image">![](../img/book_educated.jpeg)</div><div class="album-info"><p class="mb-0"><strong>Subtitle</strong>: nan<br><strong>Year:</strong> 2018<br><strong>Rating:</strong> 10/10<br></p></div></div><div class="toggle-tags"><div class="d-flex flex-wrap gap-2 mb-2 mt-2"><button id="personal_favorite" class="badge bg-primary rounded-pill border-0" onclick="toggleTag(this, 'personal_favorite')">❤️ Personal Favorite</button><button id="memoir" class="badge bg-primary rounded-pill border-0" onclick="toggleTag(this, 'memoir')">Memoir</button></div></div>
...
<div class="album-container"><div class="album-image">![](../img/book_doughnut_economics.jpeg)</div><div class="album-info"><p class="mb-0"><strong>Subtitle</strong>: Seven Ways to Think Like a 21st-Century Economist<br><strong>Year:</strong> 2017<br><strong>Rating:</strong> 9/10<br></p></div></div><div class="toggle-tags"><div class="d-flex flex-wrap gap-2 mb-2 mt-2"><button id="essential_reading" class="badge bg-primary rounded-pill border-0" onclick="toggleTag(this, 'essential_reading')">⭐ Essential Reading</button><button id="economics" class="badge bg-primary rounded-pill border-0" onclick="toggleTag(this, 'economics')">Economics</button></div></div>
...
<div class="album-container"><div class="album-image">![](../img/book_bad_science.jpeg)</div><div class="album-info"><p class="mb-0"><strong>Subtitle</strong>: Quacks, Hacks, and Big Pharma Flacks<br><strong>Year:</strong> 2008<br><strong>Rating:</strong> 9/10<br></p></div></div><div class="toggle-tags"><div class="d-flex flex-wrap gap-2 mb-2 mt-2"><button id="science" class="badge bg-primary rounded-pill border-0" onclick="toggleTag(this, 'science')">Science</button></div></div>
